...
// === TIERS ===
const tiers = [
  { name: "Basic", desc: "Para profissionais que querem viver o evento completo e acessar o conteúdo essencial.", old: "697 €", price: "497 €", includes: ["Acesso aos 2 dias completos","Palestras internacionais","Tradução simultânea português-espanhol","Almoços dia 1 e dia 2","Networking","Acesso à Cena Branca de Gala com jantar","Kit de boas-vindas padrão","Certificado digital de participação","Vale de 497 € em formação"], excludes: ["Kit de negócio premium","Jantar privado Divine Night","Hospedagem","Primeira fila"], link: "https://buy.stripe.com/cNifZjdCn2gZ5WqgBH7kc00" },
  { name: "Gold", desc: "Para profissionais que querem uma experiência mais completa, com mais valor e benefícios premium.", old: "997 €", price: "797 €", badge: "MAIS ESCOLHIDO", badgeClass: "tier-badge-gold", hl: true, includes: ["Tudo o incluído em Basic","Kit de negócio avaliado em 200 €","Localização preferencial na Cena Branca de Gala","Brinde surpresa de sponsor","Certificado físico premium","Vale de 797 € em formação"], excludes: ["Jantar privado Divine Night","Hospedagem incluída"], link: "https://buy.stripe.com/cNibJ30PB7BjacG7177kc01" },
  { name: "Divine VIP", desc: "Para quem quer viver o MAGColor Experience no nível máximo. Apenas 10 vagas.", old: "1.597 €", price: "1.297 €", badge: "APENAS 10 VAGAS", badgeClass: "tier-badge-red", includes: ["Tudo o incluído em Gold","Primeira fila garantida","Divine Night: jantar privado VIP","2 noites de hospedagem (duplo compartilhado)","Café da manhã no Hotel HF Fénix Lisboa","Acesso preferencial","Meet & Greet privado com palestrantes","Direito a voto popular no campeonato","Credencial personalizada","Mesa VIP na Cena Branca de Gala","Vale de 1.297 € em formação"], excludes: [], link: "https://buy.stripe.com/6oUcN769V08RgB43OV7kc02" }
];
